...
CREATE TABLE public.user_detail (
    ...
    other_name character varying(40),
...
1	admin	$2b$12$LOJnaGnDpOLAqqC0nQptS..Jj..cmTDbf101zGK3cHkRZrC/jghJm
\.
...
--
-- Name: ix_user_detail_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_user_detail_id ON public.user_detail USING btree (id);
...
--
-- Name: user_detail user_detail_city_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_detail
    ADD CONSTRAINT user_detail_city_fkey FOREIGN KEY (city) REFERENCES public.city(id);


--
-- Name: user_detail user_detail_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_detail
    ADD CONSTRAINT user_detail_id_fkey FOREIGN KEY (id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
